...
CREATE TABLE `QuestionnaireAnswers` (
  ...
  PRIMARY KEY (`ApplicantID`,`QuestionID`),
  KEY `fk_applicationquestionsquestionid_idx` (`QuestionID`),
  CONSTRAINT `fk_applicationquestionsquestionid` FOREIGN KEY (`QuestionID`) REFERENCES `QuestionnaireQuestions` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2022-10-05 15:17:20
