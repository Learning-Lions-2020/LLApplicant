...
CREATE TABLE `ApplicationTests` (
  ...
  CONSTRAINT `fk_applicationtestapplicantid` FOREIGN KEY (`ApplicantID`) REFERENCES `Applicants` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ApplicationTests`
--

LOCK TABLES `ApplicationTests` WRITE;
...
-- Dump completed on 2022-10-05 15:17:42
